...
let handler = async (m, { conn }) => {
    ...
    try {
        const response = await axios.get('https://raw.githubusercontent.com/Elpapiema/CharHub-Store/refs/heads/main/video_json/NSFW/anal.json');
...
handler.tags = ['nsfw'];
handler.command = ['anal', 'culiar', 'detonar'];
handler.group = true;
